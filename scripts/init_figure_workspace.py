...
TEMPLATES = {
    ...
    "asset-ledger.md": """# Asset ledger\n\n## Named search plan\n| Node id | Canonical entity | Chinese/English aliases | Providers searched | Candidate asset pages / previews | Selection/fallback reason |\n|---|---|---|---|---|---|\n| | | | cached Flaticon/Iconfont; Flaticon; Alibaba Iconfont; fallback providers | | |\n\n## Used assets\n| Asset | Role | Provider / author / pack | Asset-page URL | License state | Downloaded local SVG | Editable? | Color mode | Decision |\n|---|---|---|---|---|---|---|---|---|\n| | input/context | | | | | | | |\n\nPhysical/context assets use a Flaticon/Alibaba Iconfont external-provider-first policy. A cached asset counts only when its provider provenance is complete. Generated concept images are references unless explicitly approved as input/context assets. Do not embed a screenshot of the entire algorithm as the final figure. Primitive-built physical/context icons require a documented preferred-provider search failure or a user request for a custom symbol; never substitute one silently.\n""",
